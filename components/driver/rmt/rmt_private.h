...
struct rmt_channel_t {
    ...
    atomic_t fsm;                       // channel life cycle specific FSM @see rmt_fsm_t
...
struct rmt_tx_channel_t {
    ...
    struct k_msgq trans_queue_structs[RMT_TX_QUEUE_MAX]; // memory to store the static structure for trans_queues
